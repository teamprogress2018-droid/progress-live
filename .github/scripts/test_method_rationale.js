...
ok('cache bumps',html.includes('01-core.js?v=50')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=28')&&html.includes('05-clients-builder-plans-calendar.js?v=34')&&html.includes('styles.css?v=53'));
