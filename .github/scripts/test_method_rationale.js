...
ok('cache bumps',html.includes('01-core.js?v=88')&&html.includes('02-workouts-onboarding-templates-live.js?v=48')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=30')&&html.includes('05-clients-builder-plans-calendar.js?v=47')&&html.includes('09-posture-kb-invites-private.js?v=36')&&html.includes('styles.css?v=73'));
