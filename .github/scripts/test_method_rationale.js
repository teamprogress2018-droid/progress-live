...
ok('cache bumps',html.includes('01-core.js?v=116')&&html.includes('02-workouts-onboarding-templates-live.js?v=78')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=42')&&html.includes('05-clients-builder-plans-calendar.js?v=78')&&html.includes('09-posture-kb-invites-private.js?v=51')&&html.includes('styles.css?v=103'));
