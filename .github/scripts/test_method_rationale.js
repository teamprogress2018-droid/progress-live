...
ok('cache bumps',html.includes('01-core.js?v=46')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=28')&&html.includes('05-clients-builder-plans-calendar.js?v=32')&&html.includes('styles.css?v=50'));
