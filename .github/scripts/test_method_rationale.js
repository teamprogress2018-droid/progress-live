...
ok('cache bumps',html.includes('01-core.js?v=90')&&html.includes('02-workouts-onboarding-templates-live.js?v=52')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=32')&&html.includes('05-clients-builder-plans-calendar.js?v=49')&&html.includes('09-posture-kb-invites-private.js?v=37')&&html.includes('styles.css?v=76'));
ok('cache bumps',html.includes('01-core.js?v=89')&&html.includes('02-workouts-onboarding-templates-live.js?v=52')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=31')&&html.includes('05-clients-builder-plans-calendar.js?v=48')&&html.includes('09-posture-kb-invites-private.js?v=36')&&html.includes('styles.css?v=75'));
