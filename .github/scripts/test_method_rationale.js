...
ok('cache bumps',html.includes('01-core.js?v=105')&&html.includes('02-workouts-onboarding-templates-live.js?v=69')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=35')&&html.includes('05-clients-builder-plans-calendar.js?v=68')&&html.includes('09-posture-kb-invites-private.js?v=46')&&html.includes('styles.css?v=84'));
