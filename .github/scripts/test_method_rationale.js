...
ok('cache bumps',html.includes('01-core.js?v=47')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=28')&&html.includes('05-clients-builder-plans-calendar.js?v=32')&&html.includes('styles.css?v=51'));
ok('cache bumps',html.includes('01-core.js?v=47')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=28')&&html.includes('05-clients-builder-plans-calendar.js?v=33')&&html.includes('styles.css?v=51'));
