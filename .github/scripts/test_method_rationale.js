...
ok('cache bumps',html.includes('01-core.js?v=109')&&html.includes('02-workouts-onboarding-templates-live.js?v=73')&&html.includes('03-ai-plangen-bizstats-aicoach.js?v=37')&&html.includes('05-clients-builder-plans-calendar.js?v=76')&&html.includes('09-posture-kb-invites-private.js?v=50')&&html.includes('styles.css?v=90'));
