...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=32') && html.includes('05-clients-builder-plans-calendar.js?v=45') && html.includes('06-inbox-exercises-ai-programs.js?v=71') && html.includes('styles.css?v=71'));
