...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=33') && html.includes('05-clients-builder-plans-calendar.js?v=52') && html.includes('06-inbox-exercises-ai-programs.js?v=74') && html.includes('styles.css?v=79'));
