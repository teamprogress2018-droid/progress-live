...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=31') && html.includes('05-clients-builder-plans-calendar.js?v=44') && html.includes('06-inbox-exercises-ai-programs.js?v=66') && html.includes('styles.css?v=64'));
