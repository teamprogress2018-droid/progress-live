...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=33') && html.includes('05-clients-builder-plans-calendar.js?v=48') && html.includes('06-inbox-exercises-ai-programs.js?v=72') && html.includes('styles.css?v=74'));
