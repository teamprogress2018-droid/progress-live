...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=41') && html.includes('05-clients-builder-plans-calendar.js?v=78') && html.includes('06-inbox-exercises-ai-programs.js?v=84') && html.includes('styles.css?v=107'));
