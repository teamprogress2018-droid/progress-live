...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=37') && html.includes('05-clients-builder-plans-calendar.js?v=70') && html.includes('06-inbox-exercises-ai-programs.js?v=75') && html.includes('styles.css?v=85'));
