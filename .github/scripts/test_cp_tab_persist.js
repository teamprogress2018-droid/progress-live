...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=30') && html.includes('05-clients-builder-plans-calendar.js?v=36') && html.includes('06-inbox-exercises-ai-programs.js?v=57') && html.includes('styles.css?v=56'));
