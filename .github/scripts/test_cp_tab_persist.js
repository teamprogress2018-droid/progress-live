...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=25') && html.includes('05-clients-builder-plans-calendar.js?v=28') && html.includes('06-inbox-exercises-ai-programs.js?v=26') && html.includes('styles.css?v=41'));
