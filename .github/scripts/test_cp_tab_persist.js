...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=39') && html.includes('05-clients-builder-plans-calendar.js?v=76') && html.includes('06-inbox-exercises-ai-programs.js?v=82') && html.includes('styles.css?v=97'));
