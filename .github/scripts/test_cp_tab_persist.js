...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=35') && html.includes('05-clients-builder-plans-calendar.js?v=60') && html.includes('06-inbox-exercises-ai-programs.js?v=74') && html.includes('styles.css?v=80'));
