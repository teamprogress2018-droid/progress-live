...
ok('cache 01', html.includes('01-core.js?v=71'));
ok('cache 05', html.includes('05-clients-builder-plans-calendar.js?v=37'));
ok('cache 06', html.includes('06-inbox-exercises-ai-programs.js?v=59'));
