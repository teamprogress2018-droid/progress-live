...
ok('plan tab header actions',planTab.includes('Stwórz własny plan')&&planTab.includes('Przypisz szablon')&&planTab.includes('Generuj plan AI')&&planTab.includes('Kontynuuj plan z Fitebo'));
...
ok('cache bump',html.includes('08-client-profile-extras.js?v=48'));
