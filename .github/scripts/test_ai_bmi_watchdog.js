...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=29') && html.includes('08-client-profile-extras.js?v=34') && html.includes('06-inbox-exercises-ai-programs.js?v=32') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=28') && html.includes('04-client-portal.js?v=34') && html.includes('styles.css?v=51'));
