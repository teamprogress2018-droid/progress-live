...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=31') && html.includes('08-client-profile-extras.js?v=47') && html.includes('06-inbox-exercises-ai-programs.js?v=64') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=29') && html.includes('04-client-portal.js?v=38') && html.includes('styles.css?v=64'));
ok('cache', html.includes('07-forms-metrics-calculator.js?v=31') && html.includes('08-client-profile-extras.js?v=47') && html.includes('06-inbox-exercises-ai-programs.js?v=62') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=29') && html.includes('04-client-portal.js?v=38') && html.includes('styles.css?v=64'));
