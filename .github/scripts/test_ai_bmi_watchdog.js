...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=39') && html.includes('08-client-profile-extras.js?v=61') && html.includes('06-inbox-exercises-ai-programs.js?v=82') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=37') && html.includes('04-client-portal.js?v=52') && html.includes('styles.css?v=97'));
