...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=33') && html.includes('08-client-profile-extras.js?v=47') && html.includes('06-inbox-exercises-ai-programs.js?v=71') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=30') && html.includes('04-client-portal.js?v=39') && html.includes('styles.css?v=73'));
