...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=30') && html.includes('08-client-profile-extras.js?v=42') && html.includes('06-inbox-exercises-ai-programs.js?v=62') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=29') && html.includes('04-client-portal.js?v=37') && html.includes('styles.css?v=60'));
ok('cache', html.includes('07-forms-metrics-calculator.js?v=30') && html.includes('08-client-profile-extras.js?v=43') && html.includes('06-inbox-exercises-ai-programs.js?v=61') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=29') && html.includes('04-client-portal.js?v=37') && html.includes('styles.css?v=59'));
ok('cache', html.includes('07-forms-metrics-calculator.js?v=30') && html.includes('08-client-profile-extras.js?v=42') && html.includes('06-inbox-exercises-ai-programs.js?v=61') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=29') && html.includes('04-client-portal.js?v=37') && html.includes('styles.css?v=60'));
