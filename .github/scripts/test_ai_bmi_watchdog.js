...
ok('cache', html.includes('07-forms-metrics-calculator.js?v=40') && html.includes('08-client-profile-extras.js?v=63') && html.includes('06-inbox-exercises-ai-programs.js?v=84') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=42') && html.includes('04-client-portal.js?v=53') && html.includes('styles.css?v=100'));
