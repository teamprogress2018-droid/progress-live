...
ok('cache 06 v39', html.includes('06-inbox-exercises-ai-programs.js?v=64'));
ok('cache 06 v39', html.includes('06-inbox-exercises-ai-programs.js?v=62'));
ok('cache styles v52', html.includes('styles.css?v=64'));
