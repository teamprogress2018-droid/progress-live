...
ok('cache 05', html.includes('05-clients-builder-plans-calendar.js?v=73'));
ok('cache 06', html.includes('06-inbox-exercises-ai-programs.js?v=77'));
ok('cache 03', html.includes('03-ai-plangen-bizstats-aicoach.js?v=36'));
