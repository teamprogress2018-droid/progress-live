...
ok('cache bumps',html.includes('08-client-profile-extras.js?v=31')&&html.includes('04-client-portal.js?v=32')&&html.includes('styles.css?v=45'));
ok('cache bumps',html.includes('08-client-profile-extras.js?v=31')&&html.includes('04-client-portal.js?v=32')&&html.includes('styles.css?v=46'));
