...
ok('cache bumps',html.includes('08-client-profile-extras.js?v=43')&&html.includes('04-client-portal.js?v=37')&&html.includes('styles.css?v=59'));
ok('cache bumps',html.includes('08-client-profile-extras.js?v=42')&&html.includes('04-client-portal.js?v=37')&&html.includes('styles.css?v=60'));
