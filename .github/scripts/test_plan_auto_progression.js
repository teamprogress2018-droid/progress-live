...
ok('live shows progHint', /progHint/.test(live));
ok('CI', wf.includes('test_plan_auto_progression.js'));
ok('cache 01', html.includes('01-core.js?v=86'));
ok('cache 02', html.includes('02-workouts-onboarding-templates-live.js?v=42'));
ok('cache 05', html.includes('05-clients-builder-plans-calendar.js?v=46'));
ok('cache 10', html.includes('10-client-app.js?v=32'));
...
ok('last kg without reps keeps kg + plan reps', noReps.kg === '16' && noReps.reps === '10', JSON.stringify(noReps));
