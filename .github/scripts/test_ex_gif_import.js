...
ok('cache 06 v47', html.includes('06-inbox-exercises-ai-programs.js?v=81'));
ok('cache 01 v64', html.includes('01-core.js?v=110'));
ok('cache 01 v64', html.includes('01-core.js?v=109'));
