...
ok('cache 02 v27', html.includes('02-workouts-onboarding-templates-live.js?v=74'));
ok('cache 02 v27', html.includes('02-workouts-onboarding-templates-live.js?v=73'));
ok('cache styles v55', html.includes('styles.css?v=92'));
