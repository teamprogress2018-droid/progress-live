...
ok('cache 02 v27', html.includes('02-workouts-onboarding-templates-live.js?v=40'));
ok('cache styles v55', html.includes('styles.css?v=70'));
ok('cache 02 v31', html.includes('02-workouts-onboarding-templates-live.js?v=40'));
