...
ok('cache 02 v27', html.includes('02-workouts-onboarding-templates-live.js?v=52'));
ok('cache styles v55', html.includes('styles.css?v=76'));
ok('cache styles v55', html.includes('styles.css?v=75'));
