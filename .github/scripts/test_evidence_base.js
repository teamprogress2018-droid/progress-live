...
ok('cache bumps',html.includes('01-core.js?v=108')&&html.includes('09-posture-kb-invites-private.js?v=50'));
...
ok('cache bumps',html.includes('01-core.js?v=110')&&html.includes('09-posture-kb-invites-private.js?v=49'));
const wf=fs.readFileSync(path.join(root,'.github/workflows/check.yml'),'utf8');
ok('CI ui',wf.includes('test_kb_notes_evidence_ui.js'));
ok('cache bumps',html.includes('01-core.js?v=110')&&html.includes('09-posture-kb-invites-private.js?v=49'));
