...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=37') && html.includes('08-client-profile-extras.js?v=60') && html.includes('09-posture-kb-invites-private.js?v=46') && html.includes('styles.css?v=85'));
