...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=25') && html.includes('08-client-profile-extras.js?v=28') && html.includes('09-posture-kb-invites-private.js?v=31') && html.includes('styles.css?v=37'));
