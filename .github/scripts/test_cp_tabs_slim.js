...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=39') && html.includes('08-client-profile-extras.js?v=61') && html.includes('09-posture-kb-invites-private.js?v=50') && html.includes('styles.css?v=91'));
