...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=33') && html.includes('08-client-profile-extras.js?v=53') && html.includes('09-posture-kb-invites-private.js?v=39') && html.includes('styles.css?v=79'));
