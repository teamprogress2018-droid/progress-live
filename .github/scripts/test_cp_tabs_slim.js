...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=41') && html.includes('08-client-profile-extras.js?v=80') && html.includes('09-posture-kb-invites-private.js?v=52') && html.includes('styles.css?v=110'));
