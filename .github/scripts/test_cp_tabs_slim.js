...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=30') && html.includes('08-client-profile-extras.js?v=38') && html.includes('09-posture-kb-invites-private.js?v=34') && html.includes('styles.css?v=56'));
