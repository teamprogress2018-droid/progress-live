...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=27') && html.includes('08-client-profile-extras.js?v=32') && html.includes('09-posture-kb-invites-private.js?v=33') && html.includes('styles.css?v=47'));
