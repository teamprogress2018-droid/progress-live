...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=37') && html.includes('08-client-profile-extras.js?v=55') && html.includes('09-posture-kb-invites-private.js?v=44') && html.includes('styles.css?v=80'));
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=37') && html.includes('08-client-profile-extras.js?v=55') && html.includes('09-posture-kb-invites-private.js?v=45') && html.includes('styles.css?v=80'));
