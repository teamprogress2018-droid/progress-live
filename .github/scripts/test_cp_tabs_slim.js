...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=42') && html.includes('08-client-profile-extras.js?v=84') && html.includes('09-posture-kb-invites-private.js?v=54') && html.includes('styles.css?v=118'));
