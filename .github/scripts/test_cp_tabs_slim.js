...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=29') && html.includes('08-client-profile-extras.js?v=35') && html.includes('09-posture-kb-invites-private.js?v=34') && html.includes('styles.css?v=51'));
