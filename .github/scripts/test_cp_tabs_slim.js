...
ok('cache bumps', html.includes('07-forms-metrics-calculator.js?v=40') && html.includes('08-client-profile-extras.js?v=69') && html.includes('09-posture-kb-invites-private.js?v=51') && html.includes('styles.css?v=103'));
