...
ok('cache bumps', html.includes('01-core.js?v=39') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=25') && html.includes('05-clients-builder-plans-calendar.js?v=28'));
ok('cache bumps', html.includes('01-core.js?v=41') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=24') && html.includes('05-clients-builder-plans-calendar.js?v=28'));
