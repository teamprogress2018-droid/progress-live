...
ok('cache bumps', html.includes('01-core.js?v=32') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=23') && html.includes('05-clients-builder-plans-calendar.js?v=28'));
ok('cache bumps', html.includes('01-core.js?v=33') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=22') && html.includes('05-clients-builder-plans-calendar.js?v=27'));
ok('cache bumps', html.includes('01-core.js?v=32') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=22') && html.includes('05-clients-builder-plans-calendar.js?v=28'));
