...
ok('cache bumps', html.includes('01-core.js?v=89') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=31') && html.includes('05-clients-builder-plans-calendar.js?v=48'));
