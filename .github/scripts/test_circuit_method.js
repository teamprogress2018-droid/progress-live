...
ok('cache bumps', html.includes('01-core.js?v=43') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=26') && html.includes('05-clients-builder-plans-calendar.js?v=30'));
ok('cache bumps', html.includes('01-core.js?v=45') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=26') && html.includes('05-clients-builder-plans-calendar.js?v=30'));
ok('cache bumps', html.includes('01-core.js?v=45') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=26') && html.includes('05-clients-builder-plans-calendar.js?v=29'));
