...
ok('cache bumps', html.includes('01-core.js?v=88') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=30') && html.includes('05-clients-builder-plans-calendar.js?v=48'));
