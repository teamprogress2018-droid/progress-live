...
ok('cache 01 v89', html.includes('01-core.js?v=103'));
ok('cache 02 v49', html.includes('02-workouts-onboarding-templates-live.js?v=60'));
ok('cache 08 v50', html.includes('08-client-profile-extras.js?v=55'));
