...
ok('cache', html.includes('01-core.js?v=122') && html.includes('02-workouts-onboarding-templates-live.js?v=85') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=42') && html.includes('05-clients-builder-plans-calendar.js?v=79') && html.includes('07-forms-metrics-calculator.js?v=42'));
