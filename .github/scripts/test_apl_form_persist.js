...
ok('cache', html.includes('01-core.js?v=102') && html.includes('02-workouts-onboarding-templates-live.js?v=60') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=34') && html.includes('05-clients-builder-plans-calendar.js?v=57'));
