...
ok('cache pins',html.includes('01-core.js?v=124')&&html.includes('05-clients-builder-plans-calendar.js?v=80')&&html.includes('09-posture-kb-invites-private.js?v=53')&&html.includes('styles.css?v=116'));
