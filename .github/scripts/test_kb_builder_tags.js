...
ok('cache pins',html.includes('01-core.js?v=121')&&html.includes('05-clients-builder-plans-calendar.js?v=78')&&html.includes('09-posture-kb-invites-private.js?v=52')&&html.includes('styles.css?v=113'));
