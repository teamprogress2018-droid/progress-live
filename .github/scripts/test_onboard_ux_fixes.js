...
ok('plan tab CTAs gated on empty', src08.includes('${!plans.length?`<div style="display:flex;gap:6px') && src08.includes('Generuj plan AI'));
...
ok('cache pins', html.includes('02-workouts-onboarding-templates-live.js?v=67') && html.includes('05-clients-builder-plans-calendar.js?v=65') && html.includes('06-inbox-exercises-ai-programs.js?v=75') && html.includes('08-client-profile-extras.js?v=56') && html.includes('09-posture-kb-invites-private.js?v=46') && html.includes('styles.css?v=81'));
ok('CI', wf.includes('test_onboard_ux_fixes.js'));
