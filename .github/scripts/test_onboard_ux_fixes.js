...
ok('cache pins', html.includes('02-workouts-onboarding-templates-live.js?v=85') && html.includes('05-clients-builder-plans-calendar.js?v=79') && html.includes('06-inbox-exercises-ai-programs.js?v=84') && html.includes('08-client-profile-extras.js?v=82') && html.includes('09-posture-kb-invites-private.js?v=53') && html.includes('styles.css?v=114'));
