...
ok('cache 09', /09-posture-kb-invites-private\.js\?v=50/.test(fs.readFileSync(path.join(root, 'index.html'), 'utf8')));
ok('cache 04', /04-client-portal\.js\?v=52/.test(fs.readFileSync(path.join(root, 'index.html'), 'utf8')));
