...
ok('cache 04/05/08', html.includes('04-client-portal.js?v=43') && html.includes('05-clients-builder-plans-calendar.js?v=56') && html.includes('08-client-profile-extras.js?v=53'));
