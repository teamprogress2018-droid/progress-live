...
ok('cache 07', html.includes('07-forms-metrics-calculator.js?v=39'));
ok('cache 04/05/08', html.includes('04-client-portal.js?v=52') && html.includes('05-clients-builder-plans-calendar.js?v=74') && html.includes('08-client-profile-extras.js?v=61'));
ok('cache 04/05/08', html.includes('04-client-portal.js?v=50') && html.includes('05-clients-builder-plans-calendar.js?v=76') && html.includes('08-client-profile-extras.js?v=61'));
ok('cache 04/05/08', html.includes('04-client-portal.js?v=51') && html.includes('05-clients-builder-plans-calendar.js?v=74') && html.includes('08-client-profile-extras.js?v=61'));
