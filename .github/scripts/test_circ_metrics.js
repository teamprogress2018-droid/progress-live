...
ok('cache 04/05/08', html.includes('04-client-portal.js?v=50') && html.includes('05-clients-builder-plans-calendar.js?v=63') && html.includes('08-client-profile-extras.js?v=55'));
