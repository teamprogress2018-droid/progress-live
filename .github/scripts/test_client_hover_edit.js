...
ok('cache bumps', html.includes('05-clients-builder-plans-calendar.js?v=74') && html.includes('styles.css?v=89') && html.includes('04-client-portal.js?v=52'));
ok('cache bumps', html.includes('05-clients-builder-plans-calendar.js?v=76') && html.includes('styles.css?v=90') && html.includes('04-client-portal.js?v=50'));
ok('cache bumps', html.includes('05-clients-builder-plans-calendar.js?v=74') && html.includes('styles.css?v=89') && html.includes('04-client-portal.js?v=51'));
