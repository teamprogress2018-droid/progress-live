...
ok('cache bumps', html.includes('styles.css?v=90') && html.includes('01-core.js?v=107') && html.includes('05-clients-builder-plans-calendar.js?v=75') && html.includes('09-posture-kb-invites-private.js?v=49'));
