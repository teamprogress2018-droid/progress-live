...
ok('cache bumps', html.includes('styles.css?v=51') && html.includes('01-core.js?v=48') && html.includes('05-clients-builder-plans-calendar.js?v=34') && html.includes('09-posture-kb-invites-private.js?v=34'));
