...
ok('cache bumps', html.includes('styles.css?v=79') && html.includes('01-core.js?v=93') && html.includes('05-clients-builder-plans-calendar.js?v=52') && html.includes('09-posture-kb-invites-private.js?v=38'));
