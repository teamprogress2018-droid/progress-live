...
ok('cache bumps', html.includes('styles.css?v=70') && html.includes('01-core.js?v=84') && html.includes('05-clients-builder-plans-calendar.js?v=44') && html.includes('09-posture-kb-invites-private.js?v=35'));
