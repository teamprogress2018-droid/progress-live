...
ok('cache bumps', html.includes('styles.css?v=64') && html.includes('01-core.js?v=80') && html.includes('05-clients-builder-plans-calendar.js?v=43') && html.includes('09-posture-kb-invites-private.js?v=35'));
