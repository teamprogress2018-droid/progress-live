...
ok('cache bumps', html.includes('styles.css?v=51') && html.includes('01-core.js?v=45') && html.includes('05-clients-builder-plans-calendar.js?v=31') && html.includes('09-posture-kb-invites-private.js?v=33'));
ok('cache bumps', html.includes('styles.css?v=50') && html.includes('01-core.js?v=46') && html.includes('05-clients-builder-plans-calendar.js?v=32') && html.includes('09-posture-kb-invites-private.js?v=34'));
