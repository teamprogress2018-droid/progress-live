...
ok('cache bumps', html.includes('styles.css?v=80') && html.includes('01-core.js?v=98') && html.includes('05-clients-builder-plans-calendar.js?v=56') && html.includes('09-posture-kb-invites-private.js?v=39'));
