...
ok('cache bumps', html.includes('styles.css?v=39') && html.includes('01-core.js?v=34') && html.includes('05-clients-builder-plans-calendar.js?v=28') && html.includes('09-posture-kb-invites-private.js?v=32'));
