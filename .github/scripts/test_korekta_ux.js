...
ok('cache bumps', html.includes('styles.css?v=59') && html.includes('01-core.js?v=73') && html.includes('05-clients-builder-plans-calendar.js?v=40') && html.includes('09-posture-kb-invites-private.js?v=35'));
ok('cache bumps', html.includes('styles.css?v=59') && html.includes('01-core.js?v=73') && html.includes('05-clients-builder-plans-calendar.js?v=40') && html.includes('09-posture-kb-invites-private.js?v=35'));
ok('cache bumps', html.includes('styles.css?v=60') && html.includes('01-core.js?v=72') && html.includes('05-clients-builder-plans-calendar.js?v=40') && html.includes('09-posture-kb-invites-private.js?v=35'));
ok('cache bumps', html.includes('styles.css?v=60') && html.includes('01-core.js?v=72') && html.includes('05-clients-builder-plans-calendar.js?v=40') && html.includes('09-posture-kb-invites-private.js?v=35'));
