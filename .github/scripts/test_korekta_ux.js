...
ok('cache bumps', html.includes('styles.css?v=85') && html.includes('01-core.js?v=106') && html.includes('05-clients-builder-plans-calendar.js?v=68') && html.includes('09-posture-kb-invites-private.js?v=46'));
