...
ok('cache bumps', html.includes('styles.css?v=97') && html.includes('01-core.js?v=111') && html.includes('05-clients-builder-plans-calendar.js?v=77') && html.includes('09-posture-kb-invites-private.js?v=51'));
