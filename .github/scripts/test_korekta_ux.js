...
ok('cache bumps', html.includes('styles.css?v=104') && html.includes('01-core.js?v=118') && html.includes('05-clients-builder-plans-calendar.js?v=78') && html.includes('09-posture-kb-invites-private.js?v=51'));
