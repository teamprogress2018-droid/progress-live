...
ok('cache bumps', html.includes('styles.css?v=74') && html.includes('01-core.js?v=89') && html.includes('05-clients-builder-plans-calendar.js?v=48') && html.includes('09-posture-kb-invites-private.js?v=36'));
