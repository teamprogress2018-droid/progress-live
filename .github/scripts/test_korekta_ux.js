...
ok('cache bumps', html.includes('styles.css?v=62') && html.includes('01-core.js?v=76') && html.includes('05-clients-builder-plans-calendar.js?v=42') && html.includes('09-posture-kb-invites-private.js?v=35'));
