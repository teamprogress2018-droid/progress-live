...
ok('cache bumps', html.includes('styles.css?v=82') && html.includes('01-core.js?v=103') && html.includes('05-clients-builder-plans-calendar.js?v=65') && html.includes('09-posture-kb-invites-private.js?v=46'));
