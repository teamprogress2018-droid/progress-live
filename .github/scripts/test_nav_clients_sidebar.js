...
ok('cache bumps', html.includes('styles.css?v=33') && html.includes('05-clients-builder-plans-calendar.js?v=26') && html.includes('07-forms-metrics-calculator.js?v=23'));
