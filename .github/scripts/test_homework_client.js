...
ok('cache 01/04/09/10', indexHtml.includes('01-core.js?v=118') && indexHtml.includes('04-client-portal.js?v=54') && indexHtml.includes('09-posture-kb-invites-private.js?v=51') && indexHtml.includes('10-client-app.js?v=41'));
