...
ok('cache 01 v71', html.includes('01-core.js?v=126'));
ok('cache 05 v74', html.includes('05-clients-builder-plans-calendar.js?v=81'));
ok('cache 08 v38', html.includes('08-client-profile-extras.js?v=84'));
ok('cache styles v89', html.includes('styles.css?v=118'));
