...
ok('cache 05 v37', html.includes('05-clients-builder-plans-calendar.js?v=65'));
ok('cache 08 v38', html.includes('08-client-profile-extras.js?v=57'));
ok('cache styles v56', html.includes('styles.css?v=81'));
