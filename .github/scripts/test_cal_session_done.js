...
ok('cache 01 v70', html.includes('01-core.js?v=70'));
ok('cache 05 v36', html.includes('05-clients-builder-plans-calendar.js?v=36'));
ok('cache 08 v38', html.includes('08-client-profile-extras.js?v=38'));
ok('cache styles v56', html.includes('styles.css?v=56'));
ok('ci unit', wf.includes('test_cal_session_done.js'));
ok('helpers in core', /function sessionHappened/.test(core) && /function sessionHappenedTip/.test(core));
...
ok('sidebar odbyte kpi', /Odbyte/.test(cal));
