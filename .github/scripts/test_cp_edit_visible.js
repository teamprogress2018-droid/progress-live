...
ok('cache 01 name sync', html.includes('01-core.js?v=123') && html.includes('09-posture-kb-invites-private.js?v=53'));
ok('cache styles v54', html.includes('styles.css?v=115'));
