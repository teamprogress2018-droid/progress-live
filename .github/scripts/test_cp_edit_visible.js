...
ok('cache 08 v37', html.includes('08-client-profile-extras.js?v=71'));
ok('cache 01 name sync', html.includes('01-core.js?v=117') && html.includes('09-posture-kb-invites-private.js?v=51'));
