...
ok('cache 08 v37', html.includes('08-client-profile-extras.js?v=59'));
ok('cache 01 name sync', html.includes('01-core.js?v=105') && html.includes('09-posture-kb-invites-private.js?v=46'));
ok('cache styles v54', html.includes('styles.css?v=84'));
