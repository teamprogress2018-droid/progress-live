...
ok('cache 01 name sync', html.includes('01-core.js?v=106') && html.includes('09-posture-kb-invites-private.js?v=49'));
ok('cache styles v54', html.includes('styles.css?v=89'));
ok('cache 01 name sync', html.includes('01-core.js?v=109') && html.includes('09-posture-kb-invites-private.js?v=49'));
ok('cache 01 name sync', html.includes('01-core.js?v=108') && html.includes('09-posture-kb-invites-private.js?v=50'));
ok('cache styles v54', html.includes('styles.css?v=90'));
