...
ok('cache 01/02/03/05/07/09', html.includes('01-core.js?v=106') && html.includes('02-workouts-onboarding-templates-live.js?v=72') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=35') && html.includes('05-clients-builder-plans-calendar.js?v=70') && html.includes('07-forms-metrics-calculator.js?v=37') && html.includes('09-posture-kb-invites-private.js?v=48'));
