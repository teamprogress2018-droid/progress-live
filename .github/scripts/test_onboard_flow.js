...
ok('settings legend is real checklist', src02.includes('function renderOnbSettings') && src02.includes("goTo('automation')") && src02.includes('ONB_CHECKLIST_IDS') && !src02.includes('onb-msg-step') && !src02.includes("id:'welcome'") && !src02.includes('Wiadomości wysyłane automatycznie na każdym etapie'));
ok('flow steps match checklist', src02.includes("['invite','baseline','schedule','plan','calendar','package']") && !src02.includes("steps:['welcome'"));
ok('cache 01/02/03/05/07/09', html.includes('01-core.js?v=106') && html.includes('02-workouts-onboarding-templates-live.js?v=73') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=37') && html.includes('05-clients-builder-plans-calendar.js?v=74') && html.includes('07-forms-metrics-calculator.js?v=39') && html.includes('09-posture-kb-invites-private.js?v=49'));
ok('cache 01/02/03/05/07/09', html.includes('01-core.js?v=109') && html.includes('02-workouts-onboarding-templates-live.js?v=73') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=37') && html.includes('05-clients-builder-plans-calendar.js?v=76') && html.includes('07-forms-metrics-calculator.js?v=39') && html.includes('09-posture-kb-invites-private.js?v=49'));
ok('cache 01/02/03/05/07/09', html.includes('01-core.js?v=108') && html.includes('02-workouts-onboarding-templates-live.js?v=73') && html.includes('03-ai-plangen-bizstats-aicoach.js?v=37') && html.includes('05-clients-builder-plans-calendar.js?v=76') && html.includes('07-forms-metrics-calculator.js?v=39') && html.includes('09-posture-kb-invites-private.js?v=50'));
