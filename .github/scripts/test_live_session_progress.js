...
ok('cache 02 v31', html.includes('02-workouts-onboarding-templates-live.js?v=52'));
ok('cache 01 v73', html.includes('01-core.js?v=90'));
ok('cache 01 v73', html.includes('01-core.js?v=89'));
