...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=95')&&html.includes('06-inbox-exercises-ai-programs.js?v=74')&&html.includes('04-client-portal.js?v=42')&&html.includes('styles.css?v=79'));
