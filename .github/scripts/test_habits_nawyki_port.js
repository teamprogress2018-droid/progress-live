...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=66')&&html.includes('06-inbox-exercises-ai-programs.js?v=49')&&html.includes('04-client-portal.js?v=36')&&html.includes('styles.css?v=55'));
