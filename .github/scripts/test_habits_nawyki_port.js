...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=112')&&html.includes('06-inbox-exercises-ai-programs.js?v=84')&&html.includes('04-client-portal.js?v=53')&&html.includes('styles.css?v=100'));
