...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=40')&&html.includes('06-inbox-exercises-ai-programs.js?v=27')&&html.includes('04-client-portal.js?v=32')&&html.includes('styles.css?v=45'));
