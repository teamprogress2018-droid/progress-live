...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=105')&&html.includes('06-inbox-exercises-ai-programs.js?v=75')&&html.includes('04-client-portal.js?v=50')&&html.includes('styles.css?v=84'));
