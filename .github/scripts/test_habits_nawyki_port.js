...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=85')&&html.includes('06-inbox-exercises-ai-programs.js?v=70')&&html.includes('04-client-portal.js?v=39')&&html.includes('styles.css?v=71'));
  ok('cache bumps',html.includes('01-core.js?v=84')&&html.includes('06-inbox-exercises-ai-programs.js?v=71')&&html.includes('04-client-portal.js?v=38')&&html.includes('styles.css?v=70'));
