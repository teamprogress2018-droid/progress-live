...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=77')&&html.includes('06-inbox-exercises-ai-programs.js?v=62')&&html.includes('04-client-portal.js?v=38')&&html.includes('styles.css?v=63'));
