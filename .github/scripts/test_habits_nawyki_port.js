...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=45')&&html.includes('06-inbox-exercises-ai-programs.js?v=29')&&html.includes('04-client-portal.js?v=33')&&html.includes('styles.css?v=48'));
