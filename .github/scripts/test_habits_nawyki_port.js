...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=119')&&html.includes('06-inbox-exercises-ai-programs.js?v=84')&&html.includes('04-client-portal.js?v=54')&&html.includes('styles.css?v=104'));
