...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=126')&&html.includes('06-inbox-exercises-ai-programs.js?v=85')&&html.includes('04-client-portal.js?v=55')&&html.includes('styles.css?v=118'));
