...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=88')&&html.includes('06-inbox-exercises-ai-programs.js?v=72')&&html.includes('04-client-portal.js?v=39')&&html.includes('styles.css?v=73'));
