...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=82')&&html.includes('06-inbox-exercises-ai-programs.js?v=67')&&html.includes('04-client-portal.js?v=38')&&html.includes('styles.css?v=66'));
  ok('cache bumps',html.includes('01-core.js?v=81')&&html.includes('06-inbox-exercises-ai-programs.js?v=67')&&html.includes('04-client-portal.js?v=38')&&html.includes('styles.css?v=66'));
