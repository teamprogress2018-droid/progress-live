...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=46')&&html.includes('06-inbox-exercises-ai-programs.js?v=30')&&html.includes('04-client-portal.js?v=34')&&html.includes('styles.css?v=51'));
