...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=98')&&html.includes('06-inbox-exercises-ai-programs.js?v=74')&&html.includes('04-client-portal.js?v=45')&&html.includes('styles.css?v=79'));
