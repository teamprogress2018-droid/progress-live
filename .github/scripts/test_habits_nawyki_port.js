...
(async()=>{
  ...
  ok('cache bumps',html.includes('01-core.js?v=56')&&html.includes('06-inbox-exercises-ai-programs.js?v=40')&&html.includes('04-client-portal.js?v=36')&&html.includes('styles.css?v=54'));
  ok('cache bumps',html.includes('01-core.js?v=57')&&html.includes('06-inbox-exercises-ai-programs.js?v=40')&&html.includes('04-client-portal.js?v=36')&&html.includes('styles.css?v=53'));
