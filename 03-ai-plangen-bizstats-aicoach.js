...
function bizForecast(D){
  ...
  return `<div style="display:flex;flex-direction:column;gap:10px;margin-top:8px;">
    ${vals.map((v,i)=>`<div style="background:var(--s3);border-radius:10px;padding:12px 14px;display:flex;align-items:center;gap:12px;">
      <div style="width:36px;height:36px;border-radius:8px;background:rgba(77,159,255,${0.1+i*0.05});display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:14px;color:var(--blue);">${months[i]}</div>
      <div style="flex:1;">
