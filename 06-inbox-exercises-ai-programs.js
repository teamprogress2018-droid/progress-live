...
{name:'Wyciskanie wąskim chwytem',aka:'Narrow Grip Bench Press, Close Grip DB Bench Press',cat:'Klatka piersiowa',eq:'Sztanga',muscle:'Triceps (główny), Klatka (wewnętrzna)',tip:'Łokcie blisko tułowia.',nsca:'3x8-12.',alt:'Wyciskanie francuskie, Dipy',img:'assets/ex/bench.svg'},
...
{name:'Martwy ciąg RDL',cat:'Plecy',eq:'Sztanga',muscle:'Dwugłowy uda, Pośladki, Prostownicy grzbietu',tip:'Biodra do tyłu, kręgosłup neutralny.',nsca:'3-4x10-12.',alt:'Martwy ciąg klasyczny, Good morning (skłon)',img:'assets/ex/deadlift.svg'},
...
{name:'Prostowanie za głowę (skull crusher)',aka:'Skull crusher, DB Skull Crusher',cat:'Triceps',eq:'Sztanga',muscle:'Triceps (długa i boczna głowa)',tip:'Opuszczaj do czoła lub za głowę.',nsca:'3x10-12.',alt:'Wyciskanie francuskie'},
...
{name:'Mostek biodrowy',aka:'DB Glute Bridge, Glute Bridge',cat:'Nogi',eq:'Własna masa',muscle:'Pośladki, Dwugłowy uda',tip:'Zatrzymanie na górze 2 sek.',nsca:'3x15-20.',alt:'Wypychanie bioder (hip thrust)'},
...
{name:'Marsz w mostku',aka:'Glute march',cat:'Pośladki',eq:'Własna masa',muscle:'Pośladki (jednostronnie), Core',tip:'Mostek + naprzemienne unoszenie kolan.',nsca:'3x10/stronę.',alt:'Wypychanie bioder jednonóż, Mostek biodrowy'},
{name:'Deska',aka:'Plank',cat:'Core',eq:'Własna masa',muscle:'Core (anteriora), Pośladki, Barki',tip:'45-60s/serie. Biodra nie opadają.',nsca:'2-3x45-60s.',alt:'Deska boczna, Rollout z kółkiem',load:'sec'},
...
{name:'Bird dog',cat:'Core',eq:'Własna masa',muscle:'Core głęboki, Prostownicy grzbietu, Pośladki',tip:'Wyciągnij przeciwne ramię i nogę.',nsca:'3x10/stronę.',alt:'Martwy robak'},
...
{name:'Chód niedźwiedzia',aka:'Bear crawl, Bear Crawl Forward and Backward',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Core, Barki, Biodra, Koordynacja',tip:'Kolana kilka cm nad podłogą.',nsca:'3x10 m.',alt:'Gąsienica (inchworm)'},
...
{name:'Cat-cow (kot-krowa)',aka:'Cat-cow',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Kręgosłup (mobilizacja), Core',tip:'Naprzemienne wyginanie i prostowanie kręgosłupa.',nsca:'2-3x10.',alt:'Poza dziecka, Nitka w igłę'},
...
{name:'World’s greatest stretch',aka:'World greatest stretch',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Biodra, Kręgosłup, Barki — mobilizacja',tip:'Wykrok + rotacja + skrzyżowanie ramion.',nsca:'2x5/stronę.',alt:'Couch stretch, Biodra 90/90'},
{name:'Biodra 90/90',aka:'Hip 90/90',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Biodra (rotacja wewnętrzna i zewnętrzna)',tip:'Nogi ugięte pod kątem 90° po obu stronach.',nsca:'2x10/stronę.',alt:'World’s greatest stretch'},
...
{name:'Rotacja piersiowa',aka:'Thoracic rotation',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Kręgosłup piersiowy (rotacja)',tip:'Ręka za głową, otwieraj klatkę.',nsca:'2x10/stronę.',alt:'Nitka w igłę, Cat-cow (kot-krowa)'},
...
{name:'Przysiad do stania',aka:'Squat to stand',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Łańcuch tylny, Mobilizacja',tip:'Stań — chwyć palce — zejdź w przysiad — wstań.',nsca:'2x10.',alt:'Gąsienica (inchworm)'},
...
{name:'Poza gołębia',aka:'Pigeon pose',cat:'Rozciąganie',eq:'Własna masa',muscle:'Pośladki, Biodra zewnętrzne, IT band',tip:'Przednia noga ugięta przed tobą.',nsca:'3x60 sek/stronę.',alt:'Rozciąganie butterfly, Rozciąganie figure-4'},
...
{name:'Rozciąganie łydek',cat:'Rozciąganie',eq:'Własna masa',muscle:'Łydki (brzuchaty i płaszczkowaty)',tip:'Przy ścianie. Prosta noga = brzuchaty.',nsca:'3x30-60 sek/noga.',alt:'Pies z głową w dół'},
...
{name:'Poza dziecka',aka:'Child pose',cat:'Rozciąganie',eq:'Własna masa',muscle:'Dolny grzbiet, Biodra, Barki',tip:'Usiądź na piętach, ramiona do przodu.',nsca:'3x60 sek.',alt:'Cat-cow (kot-krowa), Pies z głową w dół'},
{name:'Pies z głową w dół',aka:'Downward dog',cat:'Rozciąganie',eq:'Własna masa',muscle:'Łańcuch tylny, Barki, Łydki, Kręgosłup',tip:'V-kształt. Pięty do podłogi.',nsca:'3x30-60 sek.',alt:'Poza dziecka'},
...
{name:'Foam roller — plecy',aka:'Foam roller plecy',cat:'Rozciąganie',eq:'Własna masa',muscle:'Kręgosłup piersiowy, Mięśnie przykręgosłupowe',tip:'Roluj powoli. Zatrzymuj na bolących punktach.',nsca:'3-5 min.',alt:'Cat-cow (kot-krowa)'},
...
{name:'Foam roller — IT band',aka:'Foam roller IT band',cat:'Rozciąganie',eq:'Własna masa',muscle:'Pasmo biodrowo-piszczelowe',tip:'Od biodra do kolana. Zatrzymuj na napiętych miejscach.',nsca:'2-3 min/stronę.',alt:'Poza gołębia'},
...
{name:'Rozciąganie żaba',aka:'Frog stretch',cat:'Rozciąganie',eq:'Własna masa',muscle:'Przywodziciele, Biodra wewnętrzne',tip:'Na czworaka z szerokimi kolanami.',nsca:'3x60 sek.',alt:'Rozciąganie butterfly'},
...
{name:'Skakanka',aka:'Jump rope, Jump Rope Classic, Skipping, Skakanka bokserska',cat:'Cardio',eq:'Skakanka',muscle:'Łydki, Barki, Cardio',tip:'Lekkie podskoki, nadgarstki kręcą skakanką.',nsca:'5×1–2 min albo 10 min ciągle.',alt:'Pajacyki, Wysokie kolana'},
...
{name:'Unoszenie bokiem w opadzie',aka:'Bent-over lateral raise, Rear delt raise',cat:'Barki',eq:'Hantle',muscle:'Tylne barki, Rombowate',tip:'Tułów prawie równoległy. Nie zamachuj.',nsca:'3x12–15.',alt:'Odwrotne rozpiętki, Unoszenie Y'},
...
{name:'Martwy ciąg na sztywnych nogach',aka:'Stiff-leg deadlift, SLDL',cat:'Nogi',eq:'Sztanga',muscle:'Dwugłowy uda, Pośladki, Grzbiet',tip:'Nogi prawie proste. Biodra do tyłu, sztanga blisko łydek.',nsca:'3x8–12.',alt:'Martwy ciąg RDL, Rumuński martwy ciąg',img:'assets/ex/deadlift.svg'},
...
{name:'Brzuszki rowerowe',aka:'Bicycle crunch',cat:'Core',eq:'Własna masa',muscle:'Skośne, Prosty brzucha',tip:'Łokieć do przeciwnego kolana. Lędźwie przyciśnięte.',nsca:'3x16–24.',alt:'Skręty rosyjskie, Brzuszki klasyczne'},
{name:'Brzuszki odwrotne',aka:'Reverse crunch',cat:'Core',eq:'Własna masa',muscle:'Prosty brzucha (dolny)',tip:'Unoś miednicę, nie machaj nogami z rozpędu.',nsca:'3x12–15.',alt:'Unoszenie nóg leżąc, Unoszenie kolan w zwisie'},
{name:'Nożyce',aka:'Scissors, Flutter scissors',cat:'Core',eq:'Własna masa',muscle:'Core dolny, Zginacze bioder',tip:'Lędźwie na macie. Naprzemienne nogi nisko.',nsca:'3x20–40 albo 3x30 s.',alt:'Unoszenie nóg leżąc, Hollow hold'},
...
{name:'Deska z unoszeniem ramienia',aka:'Plank shoulder tap, Plank tap, Shoulder Tap Push Ups',cat:'Core',eq:'Własna masa',muscle:'Core antyrotacyjny, Barki',tip:'Stopy szerzej. Biodra nie kołyszą się przy tapnięciu.',nsca:'3x10/stronę.',alt:'Deska, Wyciskanie Pallofa'},
{name:'Deska kopenhaska',aka:'Copenhagen plank, Copenhagen adductor, Copenhagen Hip Adduction, Knees Bent Copenhagen',cat:'Core',eq:'Własna masa',muscle:'Przywodziciele, Core boczny',tip:'Górna noga na ławce. Linia bark–biodro–kostka.',nsca:'3x20–40 s/stronę.',alt:'Deska boczna, Przywodzenie biodra maszyna',load:'sec'},
{name:'Spacer walizkowy',aka:'Suitcase carry',cat:'Core',eq:'Hantle',muscle:'Core antyboczny, Chwyt, Skośne',tip:'Ciężar w jednej ręce. Nie pochylaj się w stronę hantla.',nsca:'3x20–40 m/stronę.',alt:'Spacer farmera, Spacer kelnera'},
...
{name:'Hollow rock',aka:'Hollow body rock',cat:'Core',eq:'Własna masa',muscle:'Core głęboki',tip:'Pozycja hollow, małe kołysanie. Lędźwie przyklejone.',nsca:'3x20–40 s.',alt:'Hollow hold, V-upy',load:'sec'},
...
{name:'Podrzut',aka:'Jerk, Split jerk, Push jerk',cat:'Olimpijskie',eq:'Sztanga',muscle:'Barki, Nogi, Moc',tip:'Dip-drive, nogi w rozkroku albo dip. Sztanga nad głową zablokowana.',nsca:'5x2–3.',alt:'Pchanie sztangi (jerk), Wyciskanie z wybiciem'},
...
{name:'Bieżnia',aka:'Treadmill, Bieznia, Bieg na bieżni',cat:'Cardio',eq:'Bieżnia',muscle:'Nogi, Cardio (tlenowo)',tip:'Strefa 2: da się rozmawiać. Nie trzymaj się poręczy.',nsca:'20–40 min zona 2 albo interwały.',alt:'Bieg, Marsz, Orbitrek'},
{name:'Bieg',aka:'Run, Running, Bieganie',cat:'Cardio',eq:'Własna masa',muscle:'Nogi, Cardio',tip:'Lądowanie pod biodrem. Kadencja ~170–180.',nsca:'20–40 min albo interwały.',alt:'Bieżnia, Marsz'},
{name:'Marsz',aka:'Walk, Walking, Spacer',cat:'Cardio',eq:'Własna masa',muscle:'Nogi, Cardio (niski impact)',tip:'Długi krok, ruch ramion. Można z obciążeniem.',nsca:'30–60 min.',alt:'Bieżnia, Spacer farmera'},
{name:'Schody',aka:'Stairmaster, Stair climber, Stepper',cat:'Cardio',eq:'Maszyna',muscle:'Pośladki, Czworogłowy, Cardio',tip:'Cała stopa na stopniu. Nie opieraj się o poręcze.',nsca:'10–20 min.',alt:'Wejścia na skrzynię, Bieżnia'},
{name:'Ergometr narciarski',aka:'SkiErg, Ski erg, Narty',cat:'Cardio',eq:'Maszyna',muscle:'Plecy, Core, Ramiona, Cardio',tip:'Ciąg z bioder i najszerszego, nie tylko z ramion.',nsca:'500–2000 m albo 10–15 min.',alt:'Wioślarz, Liny treningowe'},
{name:'Rower poziomy',aka:'Recumbent bike, Rower leżący',cat:'Cardio',eq:'Rower',muscle:'Czworogłowy, Cardio (łatwiej dla kręgosłupa)',tip:'Plecy oparte. Kolano lekko ugięte w wyproście.',nsca:'15–30 min zona 2.',alt:'Rower stacjonarny, Orbitrek'},
...
{name:'Siad w L',aka:'L-sit, L sit',cat:'Core',eq:'Własna masa',muscle:'Core, Zginacze bioder, Triceps',tip:'Na poręczach lub podłodze. Nogi proste, klatka otwarta.',nsca:'5x10–20 s.',alt:'Hollow hold, Zwisy nóg drążek',load:'sec'},
...
{name:'Pallof chód boczny z taśmą',aka:'Band Resisted Pallof Lateral Walk, Band Resisted Pallof Lateral Wall',cat:'Core',eq:'Taśmy',muscle:'Core antyrotacyjny, Pośladki',tip:'Pallof w wyproście ramion + kroki w bok. Nie skręcaj tułowia.',nsca:'3x8–12 kroków/stronę.',alt:'Wyciskanie Pallofa, Monster walk (chód)'},
...
{name:'Muszla z wypychaniem mini band',aka:'Clamshell Thruster with Miniband',cat:'Pośladki',eq:'Taśmy',muscle:'Pośladki średni, Core',tip:'Clamshell + wyprost bioder jak mini hip thrust na boku.',nsca:'3x10–12/stronę.',alt:'Muszla (clamshell)'},
...
{name:'Mostek izometryczny na piłce swiss',aka:'Swiss Ball Hamstring Isometric Bridge',cat:'Nogi',eq:'Własna masa',muscle:'Dwugłowy, Pośladki, Izometria',tip:'Pięty na piłce, mostek. Trzymaj linię bark–biodro–kolano.',nsca:'3x20–40 s.',alt:'Mostek biodrowy',load:'sec'},
...
{name:'Mostek izometryczny na piłce swiss (pośladki)',aka:'Swiss Ball Isometric Glute Bridge',cat:'Pośladki',eq:'Własna masa',muscle:'Pośladki (izometria)',tip:'Trzymaj wyprost bioder 20–40 s.',nsca:'3x20–40 s.',alt:'Mostek na piłce swiss',load:'sec'},
...
{name:'Unoszenie bokiem w opadzie hantle',aka:'Bent Over DB Lateral Raises',cat:'Barki',eq:'Hantle',muscle:'Tylne i środkowe barki',tip:'Tułów nachylony. Unieś na boki, kciuki lekko w dół.',nsca:'3x12–15.',alt:'Unoszenie bokiem, Odwrotne rozpiętki'},
...
{name:'Lądowanie 2 na 2',aka:'Landing - 2 to 2',cat:'Cardio',eq:'Własna masa',muscle:'Hamowanie, Plyometria',tip:'Wybicie obunóż, lądowanie obunóż. Cicho, kolana ugięte.',nsca:'4x5–8.',alt:'Skoki na skrzynię'},
{name:'Lądowanie 2 na 1',aka:'Landing - 2 to 1',cat:'Cardio',eq:'Własna masa',muscle:'Hamowanie jednonóż',tip:'Wybicie obunóż, lądowanie na jednej. Stabilizacja 2 s.',nsca:'4x4–6/noga.',alt:'Lądowanie 2 na 2'},
{name:'Lądowanie 1 na 1',aka:'Landing - 1 to 1',cat:'Cardio',eq:'Własna masa',muscle:'Hamowanie jednonóż',tip:'Hop. Lądowanie na tej samej nodze. Stick.',nsca:'4x4–6/noga.',alt:'Lądowanie 2 na 1'},
...
{name:'Depth jump',aka:'Depth Jump',cat:'Cardio',eq:'Własna masa',muscle:'Moc, SSC',tip:'Zeskok ze skrzyni i maksymalny skok w górę.',nsca:'4–6x3–5.',alt:'Skoki na skrzynię'},
...
{name:'Drop jump niska skrzynia',aka:'Drop Jump (Low Box)',cat:'Cardio',eq:'Własna masa',muscle:'Szybkie SSC',tip:'Niska skrzynia. Krótki kontakt, sztywne kostki.',nsca:'5x5–8.',alt:'Pogo w miejscu, Depth jump'},
{name:'Drop jump wysoka skrzynia',aka:'Drop Jump (High Box)',cat:'Cardio',eq:'Własna masa',muscle:'SSC, Hamowanie',tip:'Wyższa skrzynia. Kontroluj lądowanie, potem wybicie.',nsca:'4x4–6.',alt:'Drop jump niska skrzynia'},
{name:'Drop jump na skrzynię',aka:'Drop Jump on Box',cat:'Cardio',eq:'Własna masa',muscle:'Szybkie SSC',tip:'Zeskok i wybicie na skrzynię przed sobą.',nsca:'4x4–6.',alt:'Depth jump na skrzynię'},
...
{name:'Bound pionowy NCM',aka:'NCM - Vertical Bound, NCM Vertical Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, bound / naprzemiennie',tip:'Start ze statyku, bez dipu. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok poziomy NCM',aka:'NCM - Horizontal Jump, NCM Horizontal Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, obunóż',tip:'Start ze statyku, bez dipu. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop poziomy NCM',aka:'NCM - Horizontal Hop, NCM Horizontal Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, jednonóż',tip:'Start ze statyku, bez dipu. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound poziomy NCM',aka:'NCM - Horizontal Bound, NCM Horizontal Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, bound / naprzemiennie',tip:'Start ze statyku, bez dipu. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok rotacyjny NCM',aka:'NCM - Rotational Jump, NCM Rotational Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, obunóż',tip:'Start ze statyku, bez dipu. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop rotacyjny NCM',aka:'NCM - Rotational Hop, NCM Rotational Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, jednonóż',tip:'Start ze statyku, bez dipu. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound rotacyjny NCM',aka:'NCM - Rotational Bound, NCM Rotational Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, bound / naprzemiennie',tip:'Start ze statyku, bez dipu. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
...
{name:'Bound pionowy CM',aka:'CM - Vertical Bound, CM Vertical Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, bound / naprzemiennie',tip:'Szybki dip i wybicie. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
...
{name:'Hop poziomy CM',aka:'CM - Horizontal Hop, CM Horizontal Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, jednonóż',tip:'Szybki dip i wybicie. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound poziomy CM',aka:'CM - Horizontal Bound, CM Horizontal Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, bound / naprzemiennie',tip:'Szybki dip i wybicie. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
...
{name:'Hop rotacyjny CM',aka:'CM - Rotational Hop, CM Rotational Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, jednonóż',tip:'Szybki dip i wybicie. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound rotacyjny CM',aka:'CM - Rotational Bound, CM Rotational Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, bound / naprzemiennie',tip:'Szybki dip i wybicie. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok pionowy DC',aka:'DC - Vertical Jump, DC Vertical Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, obunóż',tip:'Mały kontakt, potem główny skok. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop pionowy DC',aka:'DC - Vertical Hop, DC Vertical Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, jednonóż',tip:'Mały kontakt, potem główny skok. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound pionowy DC',aka:'DC - Vertical Bound, DC Vertical Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, bound / naprzemiennie',tip:'Mały kontakt, potem główny skok. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok poziomy DC',aka:'DC - Horizontal Jump, DC Horizontal Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, obunóż',tip:'Mały kontakt, potem główny skok. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop poziomy DC',aka:'DC - Horizontal Hop, DC Horizontal Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, jednonóż',tip:'Mały kontakt, potem główny skok. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound poziomy DC',aka:'DC - Horizontal Bound, DC Horizontal Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, bound / naprzemiennie',tip:'Mały kontakt, potem główny skok. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok rotacyjny DC',aka:'DC - Rotational Jump, DC Rotational Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, obunóż',tip:'Mały kontakt, potem główny skok. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop rotacyjny DC',aka:'DC - Rotational Hop, DC Rotational Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, jednonóż',tip:'Mały kontakt, potem główny skok. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound rotacyjny DC',aka:'DC - Rotational Bound, DC Rotational Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, bound / naprzemiennie',tip:'Mały kontakt, potem główny skok. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok pionowy CON',aka:'CON - Vertical Jump, CON Vertical Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, obunóż',tip:'Powtarzaj bez pauzy. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop pionowy CON',aka:'CON - Vertical Hop, CON Vertical Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, jednonóż',tip:'Powtarzaj bez pauzy. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound pionowy CON',aka:'CON - Vertical Bound, CON Vertical Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pionowa, bound / naprzemiennie',tip:'Powtarzaj bez pauzy. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok poziomy CON',aka:'CON - Horizontal Jump, CON Horizontal Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, obunóż',tip:'Powtarzaj bez pauzy. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop poziomy CON',aka:'CON - Horizontal Hop, CON Horizontal Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, jednonóż',tip:'Powtarzaj bez pauzy. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound poziomy CON',aka:'CON - Horizontal Bound, CON Horizontal Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc pozioma, bound / naprzemiennie',tip:'Powtarzaj bez pauzy. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Skok rotacyjny CON',aka:'CON - Rotational Jump, CON Rotational Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, obunóż',tip:'Powtarzaj bez pauzy. Obunóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Hop rotacyjny CON',aka:'CON - Rotational Hop, CON Rotational Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, jednonóż',tip:'Powtarzaj bez pauzy. Jednonóż.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Bound rotacyjny CON',aka:'CON - Rotational Bound, CON Rotational Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Moc rotacyjna, bound / naprzemiennie',tip:'Powtarzaj bez pauzy. Bound / naprzemiennie.',nsca:'4–6x3–6.',alt:'Skoki na skrzynię, Skok w dal z miejsca'},
{name:'Pogo poziome CON',aka:'CON - Horizontal Pogo Jump, CON Horizontal Pogo Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, SSC poziome',tip:'Ciągłe pogo do przodu. Sztywne kostki.',nsca:'4x10–15 m.',alt:'Pogo w miejscu'},
{name:'Skok przez płotki liniowo NCM',aka:'NCM - Linear Hurdles Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. NCM, Jump. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Hop przez płotki liniowo NCM',aka:'NCM - Linear Hurdles Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. NCM, Hop. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Bound przez płotki liniowo NCM',aka:'NCM - Linear Hurdles Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. NCM, Bound. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
...
{name:'Hop przez płotki liniowo CM',aka:'CM - Linear Hurdles Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. CM, Hop. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Skok przez płotki liniowo DC',aka:'DC - Linear Hurdles Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. DC, Jump. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Hop przez płotki liniowo DC',aka:'DC - Linear Hurdles Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. DC, Hop. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Bound przez płotki liniowo DC',aka:'DC - Linear Hurdles Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. DC, Bound. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Skok przez płotki liniowo CON',aka:'CON - Linear Hurdles Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. CON, Jump. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Hop przez płotki liniowo CON',aka:'CON - Linear Hurdles Hop',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki liniowe',tip:'Płotki w linii. CON, Hop. Miękkie, szybkie lądowanie.',nsca:'4x4–8.',alt:'Skoki na skrzynię'},
{name:'Skok przez płotki bokiem NCM',aka:'NCM - Lateral Hurdles Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Jump. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem na zewnątrz NCM',aka:'NCM - Lateral Hurdles Hop (Outside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Outside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem do środka NCM',aka:'NCM - Lateral Hurdles Hop (Inside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Inside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Bound przez płotki bokiem NCM',aka:'NCM - Lateral Hurdles Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Bound. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
...
{name:'Hop płotki bokiem na zewnątrz CM',aka:'CM - Lateral Hurdles Hop (Outside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Outside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem do środka CM',aka:'CM - Lateral Hurdles Hop (Inside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Inside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Bound przez płotki bokiem CM',aka:'CM - Lateral Hurdles Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Bound. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Skok przez płotki bokiem DC',aka:'DC - Lateral Hurdles Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Jump. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem na zewnątrz DC',aka:'DC - Lateral Hurdles Hop (Outside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Outside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem do środka DC',aka:'DC - Lateral Hurdles Hop (Inside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Inside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Bound przez płotki bokiem DC',aka:'DC - Lateral Hurdles Bound',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Bound. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Skok przez płotki bokiem CON',aka:'CON - Lateral Hurdles Jump',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Jump. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem na zewnątrz CON',aka:'CON - Lateral Hurdles Hop (Outside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Outside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
{name:'Hop płotki bokiem do środka CON',aka:'CON - Lateral Hurdles Hop (Inside)',cat:'Cardio',eq:'Własna masa',muscle:'Plyometria, Płotki boczne',tip:'Płotki bokiem. Hop Inside. Lądowanie stick, biodro nad stopą.',nsca:'4x4–8.',alt:'Skoki łyżwiarskie'},
...
{name:'Uginanie ud o ławkę z ugiętym kolanem',aka:'Bent Knee Bench Hamstring',cat:'Nogi',eq:'Własna masa',muscle:'Dwugłowy',tip:'Pięty na ławce, kolana ugięte. Przyciągaj / isometric.',nsca:'3x8–12.',alt:'Uginanie ud na ślizgach'},
...
{name:'Planche na czworaka',aka:'Quadruped Planche',cat:'Core',eq:'Własna masa',muscle:'Barki, Core, Prostowniki nadgarstka',tip:'Bark nad dłońmi, kolana uniesione. Dąż do planche lean.',nsca:'4x10–20 s.',alt:'Pompki pike',load:'sec'},
...
{name:'Reverse hollow',aka:'Reverse Hollow, Reverse hollow hold',cat:'Core',eq:'Własna masa',muscle:'Prostownicy, Pośladki',tip:'Leżąc na brzuchu — przeciwstawieństwo hollow. Ramiona i nogi nisko.',nsca:'3x20–30 s.',alt:'Superman, Hollow hold',load:'sec'},
...
{name:'Wykroki z przysiadu',aka:'Squat Lunges - Home, KB Goblet Squat Lunges',cat:'Nogi',eq:'Własna masa',muscle:'Nogi, Cardio',tip:'Przysiad i od razu wykrok.',nsca:'3x8–10/stronę.',alt:'Wykroki z przysiadu goblet KB'},
...
{name:'Wiosłowanie z taśmą (warianty chwytu)',aka:'Band Row Variation, Banded Face Pull',cat:'Plecy',eq:'Taśmy',muscle:'Plecy, Tylne barki',tip:'Zmieniaj chwyt: neutralny, nachwyt, face pull.',nsca:'3x12–15.',alt:'Wiosłowanie z taśmą siedząc'},
