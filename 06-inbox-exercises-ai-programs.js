...
{name:'Thruster landmine jednorącz',aka:'Landmine Single Arm Thruster',cat:'Cardio',eq:'Sztanga',muscle:'Nogi, Barki, Core',tip:'Przysiad z landmine przy barku i wyciskanie w jednym takcie.',nsca:'3x8–12/stronę.',alt:'Wyciskanie z przysiadu (thruster), Wyciskanie landmine'},
...
{name:'Wiosłowanie z taśmą siedząc',aka:'Seated Band Row',cat:'Plecy',eq:'Taśmy',muscle:'Plecy środkowe, Biceps',tip:'Siedząc, taśma na stopach. Ciągnij do bioder, ściągaj łopatki.',nsca:'3x12–15.',alt:'Wiosłowanie wyciągiem siedząc'},
...
{name:'Aktywny zwis na kółkach',aka:'Active Dead Hang on Rings',cat:'Plecy',eq:'Własna masa',muscle:'Barki, Chwyt, Najszerszy',tip:'Zwis z barkami wciśniętymi w panewki (active hang).',nsca:'3x20–40 s.',alt:'Zwisy na drążku, Podciąganie na drążku',load:'sec'},
...
{name:'Wyciskanie z podłogi hantlem w mostku jednonóż',aka:'Single Leg Glute Bridge DB Floor Press',cat:'Klatka piersiowa',eq:'Hantle',muscle:'Klatka, Pośladki, Core',tip:'Mostek jednonóż + floor press hantlem.',nsca:'3x8–10/stronę.',alt:'Wyciskanie z podłogi KB jednorącz w mostku'},
