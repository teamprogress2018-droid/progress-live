...
{name:'Unoszenie bokiem w opadzie',aka:'Bent-over lateral raise, Rear delt raise, Bent Over DB Lateral Raises',cat:'Barki',eq:'Hantle',muscle:'Tylne barki, Rombowate',tip:'Tułów prawie równoległy. Nie zamachuj.',nsca:'3x12–15.',alt:'Odwrotne rozpiętki, Unoszenie Y'},
...
{name:'Mostek izometryczny na piłce swiss',aka:'Swiss Ball Hamstring Isometric Bridge, Swiss Ball Isometric Glute Bridge',cat:'Nogi',eq:'Własna masa',muscle:'Dwugłowy, Pośladki, Izometria',tip:'Pięty na piłce, mostek. Trzymaj linię bark–biodro–kolano.',nsca:'3x20–40 s.',alt:'Mostek biodrowy',load:'sec'},
...
{name:'Depth jump',aka:'Depth Jump, Drop Jump (Low Box), Drop Jump (High Box), Drop Jump on Box',cat:'Cardio',eq:'Własna masa',muscle:'Moc, SSC',tip:'Zeskok ze skrzyni i maksymalny skok w górę.',nsca:'4–6x3–5.',alt:'Skoki na skrzynię'},
...
{name:'Uginanie ud o ławkę z ugiętym kolanem',aka:'Bent Knee Bench Hamstring, Bent Knee Bench Hamstring Curl',cat:'Nogi',eq:'Własna masa',muscle:'Dwugłowy',tip:'Pięty na ławce, kolana ugięte. Przyciągaj / isometric.',nsca:'3x8–12.',alt:'Uginanie ud na ślizgach'},
