...
{name:'Deska',aka:'Plank, Front Plank',cat:'Core',eq:'Własna masa',muscle:'Core (anteriora), Pośladki, Barki',tip:'45-60s/serie. Biodra nie opadają.',nsca:'2-3x45-60s.',alt:'Deska boczna, Rollout z kółkiem',load:'sec'},
...
{name:'Skręty rosyjskie',aka:'Russian twist, Russian Twist with Plate',cat:'Core',eq:'Własna masa',muscle:'Skośne brzucha, Core rotacyjny',tip:'Plecy pod kątem 45°.',nsca:'3x15/stronę.',alt:'Woodchop'},
...
,{name:'Uginanie ud na ławce (ugięte kolana)',aka:'Bent Knee Bench Hamstring, Bent Knee Bench Hamstring Curl',cat:'Core',eq:'Własna masa',muscle:'Dwugłowy uda, Pośladki, Core',tip:'Pięty na ławce, kolana ugięte. Unoś biodra, hamstringi trzymają.',nsca:'3x10–15.',alt:'Mostek biodrowy, Uginanie ud na ślizgach'}
