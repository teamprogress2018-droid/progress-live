...
{name:'Deska boczna',cat:'Core',eq:'Własna masa',muscle:'Skośne brzucha, Biodra',tip:'Biodra nie opadają. Ciało w linii bocznej.',nsca:'3x30-45s/stronę.',alt:'Deska',load:'sec'},
...
{name:'Zwisy na drążku',aka:'Dead hang',cat:'Core',eq:'Własna masa',muscle:'Chwyt, Barki, Kręgosłup (dekompresja)',tip:'Wisisz swobodnie na drążku.',nsca:'3xmax czas.',alt:'Spacer farmera, Podciąganie',load:'sec'},
...
{name:'Mountain climbers',cat:'Cardio',eq:'Własna masa',muscle:'Core, Biodra, Cardio',tip:'Pozycja deski. Naprzemienne kolana.',nsca:'3x30-45 sek.',alt:'Burpees, Wysokie kolana',load:'sec'},
...
{name:'Deska kopenhaska',aka:'Copenhagen plank, Copenhagen adductor',cat:'Core',eq:'Własna masa',muscle:'Przywodziciele, Core boczny',tip:'Górna noga na ławce. Linia bark–biodro–kostka.',nsca:'3x20–40 s/stronę.',alt:'Deska boczna, Przywodzenie biodra maszyna',load:'sec'},
