...
{name:'Rozpiętki hantlami',cat:'Klatka piersiowa',eq:'Hantle',muscle:'Klatka (izolacja)',tip:'Lekkie ugięcie łokci. Skup się na rozciągnięciu klatki.',nsca:'3x12-15.',alt:'Rozpiętki na wyciągu, Butterfly (peck deck)'},
...
{name:'Wyciskanie z podłogi',aka:'Floor press',cat:'Klatka piersiowa',eq:'Sztanga',muscle:'Klatka, Triceps (bez pełnego rozciągnięcia)',tip:'Łokcie zatrzymują się o podłogę — bezpieczniej dla barków.',nsca:'3–4x6–10.',alt:'Wyciskanie wąskim chwytem, Wyciskanie sztangi leżąc',img:'assets/ex/bench.svg'},
...
{name:'Ściąganie do twarzy (face pull)',aka:'Facepull',cat:'Plecy',eq:'Wyciąg',muscle:'Tylne barki, Rombowate, Rotatory',tip:'Wyciągaj do czoła, łokcie wysoko.',nsca:'3x15-20.',alt:'Odwrotne rozpiętki'},
...
{name:'Odwrotne rozpiętki',cat:'Plecy',eq:'Hantle',muscle:'Tylne barki, Rombowate',tip:'Tułów równoległy do podłogi.',nsca:'3x15.',alt:'Ściąganie do twarzy (face pull), Wiosłowanie'},
...
{name:'Wyciskanie Arnolda',aka:'Arnold press',cat:'Barki',eq:'Hantle',muscle:'Barki (wszystkie głowy), Triceps',tip:'Obrót dłoni podczas wyciskania.',nsca:'3x10-12.',alt:'Wyciskanie hantli, Wyciskanie żołnierskie OHP',img:'assets/ex/ohp.svg'},
...
{name:'Unoszenie przodem',cat:'Barki',eq:'Hantle',muscle:'Barki (przednie)',tip:'Do wysokości barków, nie wyżej.',nsca:'3x12-15.',alt:'Wyciskanie żołnierskie OHP, Unoszenie wyciągiem'},
...
{name:'Rotacja zewnętrzna',cat:'Barki',eq:'Hantle',muscle:'Rotatory barku, Podgrzebieniowy',tip:'Łokieć przy boku pod kątem 90°.',nsca:'2-3x15-20.',alt:'Rotacja na wyciągu, Ściąganie do twarzy (face pull)'},
...
{name:'Wyciskanie kubańskie',aka:'Cuban press',cat:'Barki',eq:'Hantle',muscle:'Rotatory barku, Tylne barki',tip:'Zewnętrzna rotacja + wyciskanie.',nsca:'3x10-12.',alt:'Rotacja zewnętrzna, Ściąganie do twarzy (face pull)'},
...
{name:'Unoszenie talerza przodem',aka:'Plate front raise',cat:'Barki',eq:'Hantle',muscle:'Barki (przednie)',tip:'Talerz/hantel przed sobą do wysokości barków.',nsca:'3x12–15.',alt:'Unoszenie przodem, Wyciskanie żołnierskie OHP'},
...
{name:'Kickback triceps',aka:'Kick back triceps',cat:'Triceps',eq:'Hantle',muscle:'Triceps (boczna i przyśrodkowa głowa)',tip:'Pełne wyprostowanie ramienia.',nsca:'3x12-15.',alt:'Prostowanie wyciąg'},
...
{name:'Prostowanie za głowę hantlem',aka:'Overhead triceps hantlem',cat:'Triceps',eq:'Hantle',muscle:'Triceps (długa głowa)',tip:'Łokcie blisko głowy. Opuszczaj za głowę.',nsca:'3x10–12.',alt:'Wyciskanie francuskie, Prostowanie za głowę wyciąg'},
...
{name:'Przysiad ze sztangą',cat:'Nogi',eq:'Sztanga',muscle:'Czworogłowy, Pośladki, Dwugłowy, Prostownicy',tip:'Kolana w kierunku palców. Biodra poniżej kolan.',nsca:'Siła: 4-6x3-5. Hipertrofia: 3-4x8-12.',alt:'Przysiad goblet, Przysiad przedni, Wyciskanie nogami',img:'assets/ex/squat.svg'},
...
{name:'Wyciskanie nogami',aka:'Leg press',cat:'Nogi',eq:'Maszyna',muscle:'Czworogłowy, Pośladki, Dwugłowy uda',tip:'Nie blokuj kolan całkowicie.',nsca:'3-4x10-15.',alt:'Przysiad ze sztangą'},
...
{name:'Przysiad bułgarski',aka:'Bulgarian split squat',cat:'Nogi',eq:'Hantle',muscle:'Czworogłowy, Pośladki (izolacja jednostronna)',tip:'Tylna noga na ławce.',nsca:'3x8-12/noga.',alt:'Wykrok'},
...
{name:'Mostek biodrowy',cat:'Nogi',eq:'Własna masa',muscle:'Pośladki, Dwugłowy uda',tip:'Zatrzymanie na górze 2 sek.',nsca:'3x15-20.',alt:'Wypychanie bioder (hip thrust)'},
...
{name:'Uginanie nóg maszyna',cat:'Nogi',eq:'Maszyna',muscle:'Dwugłowy uda (izolacja)',tip:'Pełny zakres ruchu.',nsca:'3x12-15.',alt:'Martwy ciąg RDL'},
{name:'Wyprosty nóg maszyna',cat:'Nogi',eq:'Maszyna',muscle:'Czworogłowy (izolacja)',tip:'Zatrzymaj na górze 1 sek.',nsca:'3x12-15.',alt:'Przysiad, Wyciskanie nogami'},
...
{name:'Wejścia na skrzynię',aka:'Step-up',cat:'Nogi',eq:'Hantle',muscle:'Czworogłowy, Pośladki (jednostronnie)',tip:'Ciężar na pięcie.',nsca:'3x10-12/noga.',alt:'Wykrok, Przysiad bułgarski'},
...
{name:'Przysiad jednonóż (pistol)',cat:'Nogi',eq:'Własna masa',muscle:'Czworogłowy, Pośladki, Stabilizacja',tip:'Zacznij od wersji na skrzynię.',nsca:'3x5-8/noga.',alt:'Przysiad bułgarski'},
{name:'Przysiad na skrzynię',aka:'Box squat',cat:'Nogi',eq:'Sztanga',muscle:'Pośladki, Czworogłowy',tip:'Usiąść na skrzynię, zatrzymać się, wstać.',nsca:'4x5-6.',alt:'Przysiad ze sztangą'},
{name:'RDL jednonóż',aka:'Single leg RDL',cat:'Nogi',eq:'Hantle',muscle:'Pośladki, Dwugłowy uda (jednostronnie)',tip:'Biodra równo. Powolne opuszczanie.',nsca:'3x10-12/noga.',alt:'Martwy ciąg RDL, Przysiad bułgarski'},
...
{name:'Przysiad przy ścianie',aka:'Wall sit',cat:'Nogi',eq:'Własna masa',muscle:'Czworogłowy (izometria), Pośladki',tip:'Plecy na ścianie, uda równoległe do podłogi.',nsca:'3x45-60 sek.',alt:'Przysiad'},
...
{name:'Wypychanie bioder jednonóż',aka:'Hip thrust jednonóż',cat:'Pośladki',eq:'Własna masa',muscle:'Pośladki (jednostronnie)',tip:'Jedna noga uniesiona.',nsca:'3x12-15/noga.',alt:'Wypychanie bioder (hip thrust)'},
...
{name:'Frog pump',cat:'Pośladki',eq:'Własna masa',muscle:'Pośladki (izolacja)',tip:'Podeszwy razem, kolana na boki. Wyciskaj biodra w górę.',nsca:'3x20–30.',alt:'Mostek biodrowy, Wypychanie bioder (hip thrust)'},
{name:'Odwrócone prostowanie tułowia',aka:'Reverse hyperextension',cat:'Pośladki',eq:'Maszyna',muscle:'Pośladki, Dolny grzbiet, Dwugłowy',tip:'Unoś nogi do linii tułowia. Nie przeprostowuj.',nsca:'3x12–15.',alt:'Prostowanie tułowia, Wypychanie bioder (hip thrust)'},
...
{name:'Deska',aka:'Plank',cat:'Core',eq:'Własna masa',muscle:'Core (anteriora), Pośladki, Barki',tip:'45-60s/serie. Biodra nie opadają.',nsca:'2-3x45-60s.',alt:'Deska boczna, Rollout z kółkiem'},
...
{name:'Hollow hold',cat:'Core',eq:'Własna masa',muscle:'Core (głęboki), Biodra',tip:'Plecy płasko na podłodze.',nsca:'3x20-30s.',alt:'Deska, Rollout z kółkiem'},
...
{name:'Deska boczna',cat:'Core',eq:'Własna masa',muscle:'Skośne brzucha, Biodra',tip:'Biodra nie opadają. Ciało w linii bocznej.',nsca:'3x30-45s/stronę.',alt:'Deska'},
...
{name:'Wyciskanie Pallofa',aka:'Pallof press',cat:'Core',eq:'Wyciąg',muscle:'Core antyrotacyjny, Stabilizacja kręgosłupa',tip:'Opieraj się rotacji.',nsca:'3x10-12/stronę.',alt:'Woodchop, Deska'},
{name:'Spacer farmera',aka:'Farmer carry',cat:'Core',eq:'Hantle',muscle:'Chwyt, Core, Trapez, Całe ciało',tip:'Plecy proste, ramiona w dół.',nsca:'3x20-30 m.',alt:'Suitcase carry'},
...
{name:'Chód niedźwiedzia',aka:'Bear crawl',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Core, Barki, Biodra, Koordynacja',tip:'Kolana kilka cm nad podłogą.',nsca:'3x10 m.',alt:'Gąsienica (inchworm)'},
...
{name:'A-skip',cat:'Rozgrzewka',eq:'Własna masa',muscle:'Biodra, Koordynacja biegowa',tip:'Rytmiczne podskoki z unosieniem kolan.',nsca:'3x10 m.',alt:'Wysokie kolana, B-skip'},
...
{name:'Mountain climbers',cat:'Cardio',eq:'Własna masa',muscle:'Core, Biodra, Cardio',tip:'Pozycja deski. Naprzemienne kolana.',nsca:'3x30-45 sek.',alt:'Burpees, Wysokie kolana'},
...
{name:'Rzut piłką znad głowy',aka:'Overhead slam, Overhead throw, Overhead med ball throw, Rzut piłką lekarską znad głowy',cat:'Cardio',eq:'Piłka lekarska',muscle:'Core, Barki, Prostownicy, Cardio',tip:'Wydłuż się w górę, rzuć piłkę w podłogę przed siebie. Nie garb się w odcinku lędźwiowym.',nsca:'3–4×8–12.',alt:'Rzut piłką o podłogę, Rzut piłką z przysiadu'},
{name:'Rzut piłką z klatki',aka:'Chest pass, Chest throw, Medicine ball chest pass, Rzut piłką lekarską z klatki',cat:'Cardio',eq:'Piłka lekarska',muscle:'Klatka, Triceps, Core, Cardio',tip:'Piłka przy klatce, wystrzel oburącz prosto przed siebie (ściana albo partner).',nsca:'3–4×10–15.',alt:'Rzut piłką o ścianę, Rzut piłką do partnera'},
...
{name:'Rzut piłką z przysiadu',aka:'Squat to throw, Squat throw, Thruster throw, Rzut piłką z przysiadu o ścianę',cat:'Cardio',eq:'Piłka lekarska',muscle:'Czworogłowy, Pośladki, Barki, Cardio',tip:'Głęboki przysiad z piłką, wybicie i rzut w górę/przód. Miękkie złapanie.',nsca:'3–4×8–12.',alt:'Rzut piłką o ścianę, Rzut piłką znad głowy'},
...
{name:'Wyciskanie hantli na podłodze',aka:'Dumbbell floor press, Floor press hantle',cat:'Klatka piersiowa',eq:'Hantle',muscle:'Klatka, Triceps',tip:'Łokcie zatrzymują się o podłogę. Stabilne barki.',nsca:'3–4x8–12.',alt:'Wyciskanie z podłogi, Wyciskanie hantli leżąc',img:'assets/ex/bench.svg'},
...
{name:'Pompki na kolanach',aka:'Knee push-up, Pompki z kolan',cat:'Klatka piersiowa',eq:'Własna masa',muscle:'Klatka, Triceps',tip:'Ciało od kolan w linii. Łokcie ~45°.',nsca:'3xmax.',alt:'Pompki, Pompki na rączkach',img:'assets/ex/bench.svg'},
{name:'Pompki z nogami na podwyższeniu',aka:'Decline push-up, Pompki decline',cat:'Klatka piersiowa',eq:'Własna masa',muscle:'Klatka górna, Barki, Triceps',tip:'Stopy na ławce. Nie zapadaj się w barkach.',nsca:'3xmax.',alt:'Pompki, Wyciskanie skos+',img:'assets/ex/bench.svg'},
...
{name:'Wyciskanie hantli jednorącz leżąc',aka:'Single-arm dumbbell bench',cat:'Klatka piersiowa',eq:'Hantle',muscle:'Klatka, Core antyrotacyjny',tip:'Druga ręka może pomagać w starcie. Napnij brzuch.',nsca:'3x8–12/stronę.',alt:'Wyciskanie hantli leżąc, Wyciskanie landmine',img:'assets/ex/bench.svg'},
...
{name:'Martwy ciąg z deficytu',aka:'Deficit deadlift',cat:'Plecy',eq:'Sztanga',muscle:'Łańcuch tylny, Czworogłowy (głębszy start)',tip:'Stój na talerzu 2–5 cm. Nie zaokrąglaj lędźwi.',nsca:'3–4x4–6.',alt:'Martwy ciąg klasyczny, Martwy ciąg trap bar',img:'assets/ex/deadlift.svg'},
...
{name:'Wyciskanie hantli stojąc',aka:'Standing dumbbell press, DB OHP stojąc',cat:'Barki',eq:'Hantle',muscle:'Barki, Triceps, Core',tip:'Napnij pośladki i brzuch. Nie wyginaj lędźwi.',nsca:'3–4x6–10.',alt:'Wyciskanie hantli siedząc, Wyciskanie żołnierskie OHP',img:'assets/ex/ohp.svg'},
...
{name:'Wyciskanie Z',aka:'Z press',cat:'Barki',eq:'Sztanga',muscle:'Barki, Core, Mobilność bioder',tip:'Siedzisz na podłodze, nogi proste. Zero zamachu nogami.',nsca:'3x5–8.',alt:'Wyciskanie żołnierskie OHP, Wyciskanie Pallofa',img:'assets/ex/ohp.svg'},
{name:'Wyciskanie hantla jednorącz nad głowę',aka:'Single-arm DB press, One-arm press',cat:'Barki',eq:'Hantle',muscle:'Barki, Core antyrotacyjny',tip:'Naprzemiennie albo jedną stronę. Biodra równo.',nsca:'3x8–12/stronę.',alt:'Wyciskanie hantli stojąc, Wyciskanie landmine',img:'assets/ex/ohp.svg'},
...
{name:'Rotacja wewnętrzna barku',aka:'Internal rotation, Cable internal rotation',cat:'Barki',eq:'Wyciąg',muscle:'Rotatory (podłopatkowy)',tip:'Łokieć przy boku. Nie ciągnij tułowiem.',nsca:'2–3x12–20/stronę.',alt:'Rotacja zewnętrzna na wyciągu'},
...
{name:'Wykrok chodzony',aka:'Walking lunge, Wykroki chodzone',cat:'Nogi',eq:'Hantle',muscle:'Czworogłowy, Pośladki',tip:'Długi krok, kolano tylne nisko. Tułów pionowo.',nsca:'3x10–12/noga.',alt:'Wykrok ze sztangą, Wykrok z hantlami',img:'assets/ex/squat.svg'},
{name:'Wykrok wsteczny',aka:'Reverse lunge, Wykrok w tył',cat:'Nogi',eq:'Hantle',muscle:'Czworogłowy, Pośladki (łagodniej dla kolan)',tip:'Krok w tył. Ciężar na przedniej pięcie.',nsca:'3x8–12/noga.',alt:'Wykrok chodzony, Przysiad bułgarski',img:'assets/ex/squat.svg'},
...
{name:'Przysiad sissy',aka:'Sissy squat',cat:'Nogi',eq:'Własna masa',muscle:'Czworogłowy (izolacja)',tip:'Kolana do przodu, biodra wyprostowane. Trzymaj się ramy.',nsca:'3x8–15.',alt:'Wyprosty nóg maszyna, Przysiad z piętami na podwyższeniu'},
{name:'Przysiad kozacki',aka:'Cossack squat',cat:'Nogi',eq:'Własna masa',muscle:'Przywodziciele, Czworogłowy, Mobilność',tip:'Szeroki rozkrok. Jedna noga ugięta, druga prosta na pięcie.',nsca:'3x6–10/stronę.',alt:'Wykrok boczny, Przysiad sumo',img:'assets/ex/squat.svg'},
...
{name:'Wyciskanie nogami jednonóż',aka:'Single-leg press',cat:'Nogi',eq:'Maszyna',muscle:'Czworogłowy, Pośladki (jednostronnie)',tip:'Stopa na środku platformy. Nie blokuj kolana.',nsca:'3x8–12/noga.',alt:'Wyciskanie nogami, Przysiad bułgarski'},
...
{name:'Wyprosty nóg jednonóż',aka:'Single-leg extension',cat:'Nogi',eq:'Maszyna',muscle:'Czworogłowy (izolacja jednostronna)',tip:'Pełny wyprost z pauzą. Druga noga odpoczywa.',nsca:'3x10–15/noga.',alt:'Wyprosty nóg maszyna, Przysiad sissy'},
...
{name:'Wypychanie bioder B-stance',aka:'B-stance hip thrust',cat:'Pośladki',eq:'Sztanga',muscle:'Pośladki (jednostronnie, stabilniej niż jednonóż)',tip:'Tylna stopa na palcach, 80% ciężaru na przedniej.',nsca:'3x8–12/stronę.',alt:'Wypychanie bioder jednonóż, Wypychanie bioder (hip thrust)'},
...
{name:'Deska z unoszeniem ramienia',aka:'Plank shoulder tap, Plank tap',cat:'Core',eq:'Własna masa',muscle:'Core antyrotacyjny, Barki',tip:'Stopy szerzej. Biodra nie kołyszą się przy tapnięciu.',nsca:'3x10/stronę.',alt:'Deska, Wyciskanie Pallofa'},
{name:'Deska kopenhaska',aka:'Copenhagen plank, Copenhagen adductor',cat:'Core',eq:'Własna masa',muscle:'Przywodziciele, Core boczny',tip:'Górna noga na ławce. Linia bark–biodro–kostka.',nsca:'3x20–40 s/stronę.',alt:'Deska boczna, Przywodzenie biodra maszyna'},
...
{name:'Hollow rock',aka:'Hollow body rock',cat:'Core',eq:'Własna masa',muscle:'Core głęboki',tip:'Pozycja hollow, małe kołysanie. Lędźwie przyklejone.',nsca:'3x20–40 s.',alt:'Hollow hold, V-upy'},
...
{name:'Burpee z hantlami (devil press)',aka:'Devil press, Devil press burpee, Burpee hantle',cat:'Cardio',eq:'Hantle',muscle:'Całe ciało, Cardio',tip:'Burpee z hantlami + swing/wyciskanie nad głowę.',nsca:'3–5x6–10 albo EMOM.',alt:'Burpees, Swing kettlebell'},
{name:'Sprawl',aka:'Sprawl, Burpee bez pompki',cat:'Cardio',eq:'Własna masa',muscle:'Cardio, Biodra, Core',tip:'Nogi w tył i z powrotem, bez pompki i wyskoku.',nsca:'3x12–20 albo 3x30–45 s.',alt:'Burpees, Mountain climbers'},
...
{name:'Wyciskanie kettlebell',aka:'Kettlebell press, KB press',cat:'Barki',eq:'Kettlebell',muscle:'Barki, Core',tip:'Z racka. Nadgarstek prosty, biodra zablokowane.',nsca:'3x6–10/stronę.',alt:'Wyciskanie hantli stojąc, Wyciskanie żołnierskie OHP',img:'assets/ex/ohp.svg'},
{name:'Wiosłowanie kettlebell',aka:'Kettlebell row, KB row',cat:'Plecy',eq:'Kettlebell',muscle:'Plecy, Biceps',tip:'Oparcie o ławkę. Ciągnij łokieć do biodra.',nsca:'3x10–12/stronę.',alt:'Wiosłowanie hantlem, Wiosłowanie Meadowsa'},
...
{name:'Przysiad TRX',aka:'TRX squat',cat:'Nogi',eq:'Taśmy',muscle:'Czworogłowy, Pośladki, Równowaga',tip:'Trzymaj taśmy, zejdź w przysiad. Pomoc w wstaniu, nie w zwisie.',nsca:'3x12–15.',alt:'Przysiad Goblet, Przysiad jednonóż (pistol)',img:'assets/ex/squat.svg'},
...
{name:'Siad w L',aka:'L-sit, L sit',cat:'Core',eq:'Własna masa',muscle:'Core, Zginacze bioder, Triceps',tip:'Na poręczach lub podłodze. Nogi proste, klatka otwarta.',nsca:'5x10–20 s.',alt:'Hollow hold, Zwisy nóg drążek'},
